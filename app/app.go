...
import (
	...
	"github.com/cicizeo/hilo/x/leverage"
	leveragekeeper "github.com/cicizeo/hilo/x/leverage/keeper"
	leveragetypes "github.com/cicizeo/hilo/x/leverage/types"
	"github.com/cicizeo/hilo/x/peggy"
	peggykeeper "github.com/cicizeo/hilo/x/peggy/keeper"
...
var (
	...
	_ servertypes.Application = (*HiloApp)(nil)
...
// HiloApp defines the ABCI application for the Hilo network as an extension of
...
// Name returns the name of the Hilo network.

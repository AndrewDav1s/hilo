...
docker-build:
	@docker build -t hilonet/hilod .

docker-build-debug:
	@docker build -t hilonet/hilod --build-arg IMG_TAG=debug .
...
proto-check-breaking:
	@$(DOCKER_BUF) breaking --against https://github.com/cicizeo/hilo.git#branch=main

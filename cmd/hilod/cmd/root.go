...
import (
	...
	"github.com/cicizeo/hilo/app/params"
)

// NewRootCmd returns the root command handler for the Hilo daemon.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		Use:   app.Name + "d",
		Short: "Hilo application network daemon and client",
		Long: `A daemon and client for interacting with the Hilo network. Hilo is a

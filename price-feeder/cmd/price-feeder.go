...
import (
	...
	"github.com/cicizeo/hilo/price-feeder/config"
	"github.com/cicizeo/hilo/price-feeder/oracle"
	"github.com/cicizeo/hilo/price-feeder/router"
...
var rootCmd = &cobra.Command{
	...
	Short: "price-feeder is a side-car process for providing Hilo's on-chain oracle with price data",
	Long: `A side-car process that Hilo validators must run in order to provide
Hilo's on-chain price oracle with price information. The price-feeder performs

...
The oracle observes the Ethereum chain for events from the [Peggy.sol](https://github.com/InjectiveLabs/loran/blob/master/solidity/contracts/Peggy.sol) contract before submitting them as messages to the Injective Chain.

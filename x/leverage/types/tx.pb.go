...
// source: hilo/leverage/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgLendAsset)(nil), "hilonetwork.hilo.leverage.v1beta1.MsgLendAsset")
	proto.RegisterType((*MsgWithdrawAsset)(nil), "hilonetwork.hilo.leverage.v1beta1.MsgWithdrawAsset")
	proto.RegisterType((*MsgSetCollateral)(nil), "hilonetwork.hilo.leverage.v1beta1.MsgSetCollateral")
	proto.RegisterType((*MsgBorrowAsset)(nil), "hilonetwork.hilo.leverage.v1beta1.MsgBorrowAsset")
	proto.RegisterType((*MsgRepayAsset)(nil), "hilonetwork.hilo.leverage.v1beta1.MsgRepayAsset")
	proto.RegisterType((*MsgLendAssetResponse)(nil), "hilonetwork.hilo.leverage.v1beta1.MsgLendAssetResponse")
	proto.RegisterType((*MsgWithdrawAssetResponse)(nil), "hilonetwork.hilo.leverage.v1beta1.MsgWithdrawAssetResponse")
	proto.RegisterType((*MsgSetCollateralResponse)(nil), "hilonetwork.hilo.leverage.v1beta1.MsgSetCollateralResponse")
	proto.RegisterType((*MsgBorrowAssetResponse)(nil), "hilonetwork.hilo.leverage.v1beta1.MsgBorrowAssetResponse")
	proto.RegisterType((*MsgRepayAssetResponse)(nil), "hilonetwork.hilo.leverage.v1beta1.MsgRepayAssetResponse")
}

func init() { proto.RegisterFile("hilo/leverage/v1beta1/tx.proto", fileDescriptor_2978bda908586e46) }
...
func (c *msgClient) LendAsset(ctx context.Context, in *MsgLendAsset, opts ...grpc.CallOption) (*MsgLendAssetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hilonetwork.hilo.leverage.v1beta1.Msg/LendAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawAsset(ctx context.Context, in *MsgWithdrawAsset, opts ...grpc.CallOption) (*MsgWithdrawAssetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hilonetwork.hilo.leverage.v1beta1.Msg/WithdrawAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetCollateral(ctx context.Context, in *MsgSetCollateral, opts ...grpc.CallOption) (*MsgSetCollateralResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hilonetwork.hilo.leverage.v1beta1.Msg/SetCollateral", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BorrowAsset(ctx context.Context, in *MsgBorrowAsset, opts ...grpc.CallOption) (*MsgBorrowAssetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hilonetwork.hilo.leverage.v1beta1.Msg/BorrowAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RepayAsset(ctx context.Context, in *MsgRepayAsset, opts ...grpc.CallOption) (*MsgRepayAssetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hilonetwork.hilo.leverage.v1beta1.Msg/RepayAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_LendAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hilonetwork.hilo.leverage.v1beta1.Msg/LendAsset",
	}
...
func _Msg_WithdrawAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hilonetwork.hilo.leverage.v1beta1.Msg/WithdrawAsset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SetCollateral_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hilonetwork.hilo.leverage.v1beta1.Msg/SetCollateral",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_BorrowAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hilonetwork.hilo.leverage.v1beta1.Msg/BorrowAsset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RepayAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hilonetwork.hilo.leverage.v1beta1.Msg/RepayAsset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "hilonetwork.hilo.leverage.v1beta1.Msg",
	...
	Metadata: "hilo/leverage/v1beta1/tx.proto",
}

...
// source: hilo/leverage/v1beta1/leverage.proto
...
// Asset defines a token in the Hilo capital facility that can be loaned and
// borrowed.
//
...
func init() {
	proto.RegisterType((*Params)(nil), "hilonetwork.hilo.leverage.v1beta1.Params")
	proto.RegisterType((*Asset)(nil), "hilonetwork.hilo.leverage.v1beta1.Asset")
}

func init() {
	proto.RegisterFile("hilo/leverage/v1beta1/leverage.proto", fileDescriptor_f9aab5daf3352690)
}

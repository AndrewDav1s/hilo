...
approach to the design, the [ADR creation process](https://github.com/cicizeo/hilo/blob/main/docs/architecture/PROCESS.md) can begin. We are following this process to ensure all involved parties
...
current [ADRs](https://github.com/cicizeo/hilo/tree/main/docs/architecture).
